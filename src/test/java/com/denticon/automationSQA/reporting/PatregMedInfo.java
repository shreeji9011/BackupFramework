...
public class PatregMedInfo extends SeleniumSuite{
...
@Test  
	...
	public boolean BlankPatientRegistrationForm(){ 
		try {
			stepInfo="Click on Reporting tab";
			flag=CommonMethods.clickIfEnable(IReport.TAB_REPORT);
 			stepInfo="Click on Daily Reporting";
 			flag=CommonMethods.clickIfEnable(IReport.LNK_PATREG_MEDICALINFO);
 			flag=CommonMethods.clickIfEnable(IReport.Lnk_BlankPatientRegistrationForm);
...
public boolean MedicalQuestionnaire(){ 
	try {
		stepInfo="Click on Reporting tab";
		flag=CommonMethods.clickIfEnable(IReport.TAB_REPORT);
			stepInfo="Click on Daily Reporting";
			flag=CommonMethods.clickIfEnable(IReport.LNK_PATREG_MEDICALINFO);
			flag=CommonMethods.clickIfEnable(IReport.Lnk_MedicalQuestionnaire);
...
public boolean DentalQuestionnaire (){ 
	try {
		stepInfo="Click on Reporting tab";
		flag=CommonMethods.clickIfEnable(IReport.TAB_REPORT);
			stepInfo="Click on Daily Reporting";
			flag=CommonMethods.clickIfEnable(IReport.LNK_PATREG_MEDICALINFO);
			flag=CommonMethods.clickIfEnable(IReport.Lnk_DentalQuestionnaire );
